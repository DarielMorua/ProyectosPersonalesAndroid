package com.dariel.relaxulsa.authboton
...
import com.dariel.relaxulsa.MainActivity

@Composable
fun AuthView(isAuthenticatedState: MutableState<Boolean>, onAuthenticated: (Boolean) -> Unit) {
